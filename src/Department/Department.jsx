        ...
        <div className=" mb-10 mt-10 mr-10 ml-10">
            ...
            <div>
               ...
               <div className=" bg-blue-100 p-2 rounded-xl flex-col md:flex-row lg:flex-row text-center">
                <h1 className="  text-blue-500 text-4xl font-bold">Health Talk working on ten Category Departments {depart.length} </h1>
            ...
            <div className=" flex justify-center items-center mb-10 mt-10 ml-10 mr-10 ">
